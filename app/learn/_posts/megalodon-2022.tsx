...
export const meta: PostMeta = {
  slug: "megalodon-2022",
  title: "Megalodon: The Biggest Shark To Ever Exist",
  dek: "A comprehensive look at the largest predatory shark in Earth's history",
  date: "2022-07-15",
  youtube_id: "yFn7Soe2FG0",
  read_minutes: 12,
  tags: ["Sharks", "Megalodon", "Marine Biology"],
  published: true,
};

export default function Megalodon2022() {
  return (
